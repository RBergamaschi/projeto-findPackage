...
class UserService:
    ...
    async def get_all_users(self, params: PaginationParams) -> PaginatedResponse[UserRead]:
        offset = (params.page - 1) * params.size
        users, total = await self.user_repository.get_all(limit=params.size, offset=offset)
